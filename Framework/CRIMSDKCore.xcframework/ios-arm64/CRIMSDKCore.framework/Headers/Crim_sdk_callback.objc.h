...
@protocol Crim_sdk_callbackUploadLogProgress;
@class Crim_sdk_callbackUploadLogProgress;
...
- (void)onRecvOnlineOnlyMsg:(NSString* _Nullable)message;
@end
...
/**
 * OnFriendReqAccepted Friend request has been accepted
 */
- (void)onFriendReqAccepted:(NSString* _Nullable)groupApplication;
/**
 * OnFriendReqAdded Someone applied to add you as a friend
 */
- (void)onFriendReqAdded:(NSString* _Nullable)friendApplication;
/**
 * OnGrpReqAccepted Group join application has been accepted
 */
- (void)onGrpReqAccepted:(NSString* _Nullable)groupApplication;
/**
 * OnGrpReqAdded Someone applied to join a group
 */
- (void)onGrpReqAdded:(NSString* _Nullable)groupApplication;
/**
 * OnRecvNewMsg Received a new message
 */
- (void)onRecvNewMsg:(NSString* _Nullable)message;
@end
...
@protocol Crim_sdk_callbackUploadLogProgress <NSObject>
...
@interface Crim_sdk_callbackUploadLogProgress : NSObject <goSeqRefInterface, Crim_sdk_callbackUploadLogProgress> {
}
@property(strong, readonly) _Nonnull id _ref;
